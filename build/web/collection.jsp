            ...
            <div class="eco-card">
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <!-- Example Static Row (Will be dynamic with JSTL later) -->
                            <tr>
                                <td>
                                    <strong>May 10, 2026</strong><br>
                                    <small class="text-muted">Morning (8AM - 12PM)</small>
                                </td>
                                <td>Medium</td>
                                <td><span class="status-pending">Pending</span></td>
                                <td class="text-end">
                                    <form action="CollectionServlet" method="POST" class="d-inline">
